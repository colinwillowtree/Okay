...
Vehicle.prototype.sizeBig = function() {
  
  var lenY = map(mouseY, 0, height, 1, 40);
  var lenX = map(mouseX, 0, width, 1, 40);
  this.sizeL2 = 0;
  this.sizeH2 = lenY;
}
...
Vehicle.prototype.show = function() {
  ...
  //fill(size*20, 100);
  //noFill();
  fill(size*3+150, size*10+150 , size*1+150 , 255);
...
Vehicle.prototype.edges = function() {
  ...
  Vehicle.prototype.drawGradient = function(x, y) {
    var radius = 20;
    var h = 255;
